...
knitr::opts_knit$set(root.dir = "~/Desktop/github/D-Lab/R-Fundamentals/")
```
...
characteristics of D-Lab Workshop learners. We might want to know the
...
```{r}
working_directory <- "~/Desktop/github/D-Lab/R-Fundamentals/"
```
...
If you take more D-Lab workshops in the future (and we hope you will!)
you will notice this pattern to read in files often.
