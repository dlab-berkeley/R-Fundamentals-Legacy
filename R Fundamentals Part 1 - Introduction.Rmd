...
author: "D-Lab"
date: "March 25, 2018 (updated `r Sys.Date()`)"
output:
  html_document: 
    number_sections: yes
    toc: yes
...
**Bonus**  
Part 5) What is RMarkdown? Why you should consider using RMarkdown (.Rmd) instead of a plain-text script.  
Part 6) For-loops and functions; Monte Carlo simulation, the "birthday problem".  
...
# `paste` - combine words into character vectors! 
