...
# C) Definition/statement/expression goes on right side
...
# 4. 
# ls() will list the variables defined in the global environment

# 5.
rm(my_city)

# 6. 
rm(list = ls()) # or simply click the broom icon in the upper-right Environment tab
```
