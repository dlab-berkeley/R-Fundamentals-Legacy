...
##  1.  Front matter: Pre-introduction
...
1. Front matter  
2. Introduction: What is RStudio?, objects, global environment, packages, variable assignment, help  
3. Atomic data types: numeric, character, and logical  
4. Data type coercion  
5. Data structures: vector, list, matrix, data frame  
6. Saving your work  
7. Homework (optional)  

##  1.  Front matter: Introduction to the class
...
# 2.  Introduction - what is RStudio?
...
# 4. Data testing and type coercion - `is.type()`
