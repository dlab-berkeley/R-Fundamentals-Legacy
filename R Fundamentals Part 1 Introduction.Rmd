...
2. `git clone git@github.com:dlab-berkeley/R-Fundamentals.git`  
...
3. What does `ls()` do? Where else do you see this information?
...
4. Wipe your environment using `rm(list=ls())` or the broom icon
...
> NOTE: we will begin Part 2 with a discussion about how to check and set the working directory. 
...
?write.csv
# answer = 
# write.csv(animals, file = "animals.csv", row.names = T)
```
