...
4) lead typing walkthoughs of these R functions  
...
### R and RStudio
R is a programming language based on the [S](https://en.wikipedia.org/wiki/S_(programming_language)) and [S-PLUS](https://en.wikipedia.org/wiki/S-PLUS) language and graphical user interface (GUI) and is **functional**, **object oriented**, and **interpreted**. These themes make R highly extensible.  
...
**Top right pane**  
contains the defined objects currently in the `global environment` and value, data, and function `history`.  
