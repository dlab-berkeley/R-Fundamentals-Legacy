...
- See the [R Markdown Reference Guide](https://rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf?_ga=2.115917006.916250004.1599550442-103987608.1598213600) to see a list of knitr chunk options. 

```{r setup, include=FALSE}

knitr::opts_chunk$set(echo = TRUE) # prevents code, but not the results from appearing in the finished file. 
...
2. Is great for data visualization  
3. Utilizes many packages written for your field  
