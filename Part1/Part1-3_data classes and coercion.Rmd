...
The logical data type consists only of `TRUE` or `FALSE`. These are stored internally 1 and 0 and as such take on mathematical properties. 
...
Remember how even whole numbers default to numeric/float/double type? Turning one data type into another requires what is called [type coercion](https://en.wikipedia.org/wiki/Type_conversion), or changing one data type to another. 
...
Factor type is simply how R refers to categorical data. You will learn more about factor types in later sections.  
