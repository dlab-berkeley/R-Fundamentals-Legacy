...
_**It is worth emphasizing the importance of data frames in R!**_ Inside R, a **DATA FRAME** is a list of equal-length vectors. These vectors can be of different types. Data frames are thus heterogeneous like lists. Data frames have the **same type of data within each column**, but **different types of data across columns!** This is simply a tabular spreadsheet of rows and columns.  
